...
${data.sections.map(renderSection).join('\n\n')}
    ...
    <p class="colophon">
      <strong>Sections are numbered in dependency order</strong> &mdash; 01 is assumed by everything after it,
      and each one leans on the ones before. If a later rule won&rsquo;t stick, the missing piece is usually earlier.
      <br><br>
      <strong>${starCount} rules are marked load-bearing.</strong> Those aren&rsquo;t the most important rules,
      they&rsquo;re the ones that <em>generate</em> other rules &mdash; understand those and several neighbours
      stop needing to be memorised at all.
      <br><br>
      <strong>&ldquo;Got it&rdquo; collapses a rule</strong> to its one line and remembers it on this device only &mdash;
      what you know on the phone is tracked separately from what you know on the TouchPad. Tick
      <em>Hide what I know</em> and the marked rules drop out of the page <em>and</em> out of the printout,
      so the sheet gets shorter as you learn. Nothing leaves the device; nothing syncs.
      <br><br>
      Print with background graphics off. It is designed to come out plain black on white, two columns, letter portrait.
    </p>
  </div>`;
